...
static void __sha256_init(sha256_t* ctx);
static void __sha256_update(sha256_t* ctx, const SHA256_BYTE data[], size_t len);
static void __sha256_final(sha256_t* ctx, SHA256_BYTE hash[]);

static void __sha256_transform(sha256_t* ctx, const SHA256_BYTE data[]) {
...
void sha256(const unsigned char* data, size_t size, unsigned char* result) {
	sha256_t context;
	__sha256_init(&context);
	__sha256_update(&context, data, size);
	__sha256_final(&context, result);
}
