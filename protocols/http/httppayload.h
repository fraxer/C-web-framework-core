 ...
 * @return heap-allocated parameter value or NULL if not found. Caller must free it.
 */
 ...
 * @param request - HTTP request instance
 * @param param_name - name of the payload parameter (null-terminated string)
 * @param ok - pointer to status flag: set to 1 on success, 0 if not found or conversion error (may be NULL)
 ...
 * @param request - HTTP request instance
 * @param param_name - name of the payload parameter (null-terminated string)
 * @param ok - pointer to status flag: set to 1 on success, 0 if not found or parse error (may be NULL)
