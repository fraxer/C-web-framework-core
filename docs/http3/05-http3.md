...
**Осталось:** несколько запросов в одном соединении параллельно (клиент шлёт по
одному, `handlers_inflight > 1` из §11 не проверен) и TSan под нагрузкой; 103 и
100-continue через `h3response_informational`; Extended CONNECT (§8); фаза 7
(Alt-Svc — без него h3 не увидит ни один браузер, свои ключи конфига, метрики).
