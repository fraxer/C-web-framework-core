...
**Осталось:** 103 и 100-continue через `h3response_informational`; Extended
CONNECT (§8); фаза 7 — Alt-Svc (без него про h3 не узнает ни один браузер), свои
ключи конфига вместо `http2_max_header_list_size`, метрики.
